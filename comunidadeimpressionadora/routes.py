...
def atualizar_cursos(form):
    lista_cursos = []
    for campo in form:    # percorre cada campo do form
        if 'curso_' in campo.name:
            if campo.data:    #se o campo do curso foi selecionado
                lista_cursos.append(campo.label.text)    # adicionar o texto do campo.label na lista de cursos
    return ';'.join(lista_cursos)    # tranformar a lista emm texto separando os itens por ';'
